...
public class AMSHookHelper {
    ...
    public static void hookActivityThreadHandler() throws Exception {
        ...
        Field currentActivityThreadField = null;
        Object currentActivityThread = null;

        try {
            currentActivityThreadField = activityThreadClass.getDeclaredField("sCurrentActivityThread");
            currentActivityThreadField.setAccessible(true);
            currentActivityThread = currentActivityThreadField.get(null);
